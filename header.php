...
<body>
    ...
    <nav class="navbar navbar-expand-lg  fixed-top navbar-light bg-light main_nav">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav box-firts-menu">
                ...
                <a class="nav-item nav-link active text-primary" href="../contact/"> <i class="fas fa-headset"></i> CONTACTOS</a>
    ...
    <nav class="navbar navbar-expand-lg navbar-light  menu-category" style="background:white; box-shadow: 100px 10px 60px #E6E6E6;">
