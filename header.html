...
<head>
    ...
    <script src="http://use.fontawesome.com/releases/v5.15.1/js/all.js"></script>
    ...
    <nav class="navbar navbar-expand-lg  fixed-top navbar-light bg-light main_nav">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav box-firts-menu">
                <a class="nav-item nav-link active text-primary" href="#"> <i class="fas fa-users "></i> AREA DE CLIENTE <span class="sr-only">(current)</span></a>
